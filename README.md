...
| Repository | Focus | Techniques |
|---|---|---|
| [MLOPs-Production-Ready-Machine-Learning-Project](https://github.com/homeshwarnelakurthi/MLOPs-Production-Ready-Machine-Learning-Project) | Production ML system (visa approval) | MongoDB, AWS S3, FastAPI, Docker, Evidently AI monitoring, CI/CD |
| [Azure-DE-Project-Resources](https://github.com/homeshwarnelakurthi/Azure-DE-Project-Resources) | Azure data engineering | Cloud data pipelines, lakehouse / ETL on Microsoft Azure |

### Predictive Modeling & Analytics
Classical ML, feature engineering, and exploratory data analysis on large real-world datasets.

| Repository | Focus | Techniques |
|---|---|---|
| [Credit-Card-Lead-Prediction](https://github.com/homeshwarnelakurthi/Credit-Card-Lead-Prediction) | Bank cross-sell propensity (245K records) | Binary classification, EDA, feature engineering |
| [Uber-Data-Analysis-Predictions](https://github.com/homeshwarnelakurthi/Uber-Data-Analysis-Predictions) | Ride-demand analysis | EDA, predictive modeling |
| [Amazon-Cell-Phones-Analysis-using-Exploratory-Data-Analysis-](https://github.com/homeshwarnelakurthi/Amazon-Cell-Phones-Analysis-using-Exploratory-Data-Analysis-) | Product / review analytics | Exploratory data analysis, visualization |
...
| Repository | Focus |
|---|---|
| [healthrecords](https://github.com/homeshwarnelakurthi/healthrecords) | Health records management |
| [secure_health](https://github.com/homeshwarnelakurthi/secure_health) | Secure health-data application |
| [health-care](https://github.com/homeshwarnelakurthi/health-care) | Healthcare data / ML application |
| [Applicatin-tracking-system](https://github.com/homeshwarnelakurthi/Applicatin-tracking-system) | Applicant tracking system |
